  ...
  <form action="../php/update/updateAdmin/updateAdminListPassword.php" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
    ...
    <div class="toDelete">
        ...
        <div class="popup_box" id="popup_box">
            ...
            <div class="buttons"><button><a style="color:white;" href="../php/delete/AdminListDelete.php">Delete</a></button><button type="button" onclick="cancelPopup();">Cancel</button></div>
        </div>
    </div>
  </form>
