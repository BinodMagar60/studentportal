...
<body>
  <div class="whole-content">
    ...
    <div class="leftside-contents">
      <div class="side-bar-titles">
        <button class="active" id="button1" onclick="toggleButton(1);adminUserProfile();" >
      ...
      <div class="side-bar-titles">
        <a class="side-panel-title"><button id="button2" onclick="toggleButton(2);adminUserSetting();">
  ...
  <script src="../js/admin-adminprofile-sidebar.js"></script>
