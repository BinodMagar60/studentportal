...
if(isset($_GET['t_email'])){
  $target_t_email=$_GET['t_email'];
  $_SESSION['target_t_email']= $target_t_email;
  }else{
    echo "not set";
  }
?>
...
<body>
  <div class="whole-content">
    ...
    <div class="leftside-contents">
      <div class="side-bar-titles">
        <button class="active" id="button1" onclick="toggleButton(1); teacherUserProfile();" >
      ...
      <div class="side-bar-titles">
        <a class="side-panel-title"><button id="button2" onclick="toggleButton(2);teacherUserSetting();">
  ...
  <script src="../js/admin-teacherdetail-sidebar.js"></script>
