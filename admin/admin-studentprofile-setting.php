...
<div class="overlay" id="overlay"></div>
  <form action="../php/update/updateStudent/updateStudentListPassword.php" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
    ...
    <div class="toDelete">
        ...
        <div class="popup_box" id="popup_box">
            ...
            <div class="buttons"><a style="color:white; text-decoration:none;" href="../php/delete/StudentListDelete.php"><button type="button">Delete</button></a><button type="button" onclick="cancelPopup();">Cancel</button></div>
        </div>
    </div>
  </form>
