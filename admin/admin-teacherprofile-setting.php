...
<div class="overlay" id="overlay"></div>  
  <form action="../php/update/updateTeacher/updateTeacherListPassword.php" method="post" enctype="multipart/form-data" novalidate autocomplete="off">
    ...
    <div class="toDelete">
        ...
        <div class="popup_box" id="popup_box">
            ...
            <div class="buttons"><button type="button"><a style="color:white; text-decoration:none;" href="../php/delete/TeacherListDelete.php">Delete</a></button><button type="button" onclick="cancelPopup();">Cancel</button></div>
        </div>
    </div>
  </form>
