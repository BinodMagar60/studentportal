...
";
*/
if(isset($sname,$saddress,$sgender,$sdob,$scontact,$smail,$simage)){
  //secure password
...
$sql1= "INSERT INTO admin_table(name,address, gender, date_of_birth, contact, email, image) VALUES ('$sname','$saddress','$sgender','$sdob','$scontact','$smail','$simage')";
